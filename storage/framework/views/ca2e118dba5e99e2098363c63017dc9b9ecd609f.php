      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                <li> <a class="<?php echo $__env->yieldContent('home'); ?>" href="/servis/user/index">Home</a></li>
...
<?php /**PATH D:\Rafel\user\resources\views/layout/servis_user.blade.php ENDPATH**/ ?>