              ...
              <tbody>
                <?php $__currentLoopData = $servis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td><a href="/servis/<?php echo e($servis->id); ?>/dtl_servis" class="badge badge-warning">Lihat Detail</a></td>
                  </tr>
...
<?php echo $__env->make('layout/servis', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\user\resources\views/servis/history.blade.php ENDPATH**/ ?>