    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
          <!-- logo start -->
          <div class="logo"> <a href="/servis/index"><img src="/assets/images/logos/logo.png" alt="logo" /></a> </div>
          <!-- logo end -->
        </div>
          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li> <a class="<?php echo $__env->yieldContent('history'); ?>" href="/servis/history">History</a></li>
...
<footer class="footer_style_2">
  ...
  <div class="cprt">
    <p>© Copyright 2045 - Els Computer | Design by <a href="https://html.design/" target="_blank">html.design</a></p>
  </div>
</footer>
<!-- end footer -->
...
<?php /**PATH D:\Rafel\user\resources\views/layout/servis.blade.php ENDPATH**/ ?>