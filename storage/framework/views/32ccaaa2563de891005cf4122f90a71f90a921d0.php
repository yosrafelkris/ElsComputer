      ...
      <div class="col-md-12">
          <div class="table-responsive">
           ...
           <p><b>Hubungi Admin Via Whatsapp - 085725964942</b> </p>
              <a target="_blank" href="https://web.whatsapp.com/send?phone=6285725964942&amp;text=Halo Admin ! saya mau tanya, untuk laptop <?php echo e($servis->barang->type); ?> dengan nomor seri <?php echo e($servis->barang->serial_num); ?> kapan bisa diambil ya? terimakasih">
              ...
              <a target="_blank" href="https://web.whatsapp.com/send?phone=6285725964942&amp;text=Halo Admin ! saya mau tanya, untuk laptop <?php echo e($servis->barang->type); ?> dengan nomor seri <?php echo e($servis->barang->serial_num); ?>, kerusakanya apa pada bagian apa ya? dan berapa perkiraan harganya? terimakasih">
                  <div style= "color: 	#000000">
...
<?php echo $__env->make('layout/page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\user\resources\views/page/dtl_servis.blade.php ENDPATH**/ ?>